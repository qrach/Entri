...
Entri["Settings"] = {
	...
	Mode = {
		Build = {
			ExitWords = {"funny", "real", "seo", "inject", "hide", "boolean", "bool", "false", "true", "fr", "ong", "based", "gui", "paste", "copy", "bin", "door", "modded", "mod", "mods", "edr", "cia", "forced", "entry", "broke", "rich", "vc", "go", "hard", "pls", "fake", "swat", "sus", "vr", "lib", "test", "cult", "phrase", "get", "post", "put", "socket", "rekt", "rep", "nsa", "spy", "edgy", "edge", "distro", "techie", "larp", "breach", "forum", "feds", "fedded", "report", "web3", "web", "crypto", "encrypt", "git", "gist", "dm", "abuse", "xss", "cmd", "logs", "access", "cookie", "funnies", "lua", "vuln", "reverse", "osint", "roli", "beam", "beamed", "straker", "method", "rolimon", "geecee", "dog", "fan", "man", "123", "db", "cracked", "crack", "entri", "script", "build", "noob", "lol", "nerd", "bro", "hot", "fe", "hacker", "hacks", "hack", "hax", "haxor", "hacksor", "haxer", "hax0r", "exploit", "pwnd", "troll", "meme", "how", "the", "when", "moment", "fe", "bypass", "novirus", "no", "scam", "2023", "free", "gooby", "agent", "dwc", "tubers", "harked", "netless", "network", "ownership", "skid", "best", "audios", "leet", "1337", "v3rm", "krnl", "syn", "sw", "proto", "celery", "astro", "cat", "vsb", "void", "shown", "corrupt", "archive", "cyc", "blox", "bloxxed", "de", "meme", "leaked", "noname", "nn", "popbob", "bigname", "newgen", "dupe", "lol", "trolleybus", "trollge"};
			Enabled = false;
			ScriptName = "";
			ExitPhrase = "";
		};
